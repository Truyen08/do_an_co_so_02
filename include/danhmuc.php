<?php
	...
	$trangdanhmuc = mysqli_query($conn, "SELECT * FROM sanpham,category WHERE sanpham.category_id = category.category_id 
	AND sanpham.category_id = '$id' ORDER BY sanpham.sanpham_id DESC");
	
	$danhmuc = mysqli_query($conn, "SELECT * FROM sanpham,category WHERE sanpham.category_id = category.category_id 
	AND sanpham.category_id = '$id' ORDER BY sanpham.sanpham_id DESC");
	$row_tendanhmuc = mysqli_fetch_array($danhmuc);
	$title = $row_tendanhmuc['category_name'];
...
?>
	...
	<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">Danh mục <?= $title?></h3>
			<!-- //tittle heading -->
			<div class="row">
				<!-- product left -->
					...
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<div class="row">
								...
								<?php
									while($row_sanpham = mysqli_fetch_array($trangdanhmuc)){
								?>
