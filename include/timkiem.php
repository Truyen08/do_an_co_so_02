<?php
	...
	$trangdanhmuc = mysqli_query($conn, "SELECT * FROM sanpham WHERE sanpham_name LIKE '%$keyword%' ORDER BY sanpham.sanpham_id DESC");
...
?>
	...
	<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">Kết quả tìm kiếm cho <?= $title?></h3>
			<!-- //tittle heading -->
			<div class="row">
				<!-- product left -->
